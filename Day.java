public class Day {
	...
	/**
	 * This method sets day through the index (0-6)
	 * @param i
	 * @param day
	 */
	...
	/**
	 * This method will calculate and return the day after a certain number of days has been added to the current day
	 * @param i
	 * @param days
	 ...
	 * @return the above phrase and the current set day
	 */
